    ...
    return PreferredSize(
      ...
      child: Container(
        ...
        child: AppBar(
          ...
          IconButton(icon: const Icon(Icons.arrow_back_ios, size: Dimensions.iconSizeDefault),
              color: Theme.of(context).textTheme.bodyLarge!.color,
              onPressed: () => onBackPressed != null ? onBackPressed!() :
               Navigator.pop(context)):const SizedBox.shrink(),
                // :
          // IconButton(icon: Image.asset(Images.logoWithAppName,height: 50,),
          //  onPressed: () {  },),
